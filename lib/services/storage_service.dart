...
class StorageService {
  ...
  Future<void> saveFriendIslands(List<IslandModel> islands) async {
    ...
    for (int i = 1; i < islands.length; i++) {
      await _islandBox.put('friend_island_${i - 1}', islands[i]);
    }
  }
  ...
  Future<Map<String, dynamic>> getStatistics() async {
    ...
    final totalSessionCount = completedSessions.length;
    final averageSessionLength = totalSessionCount > 0
        ? totalFocusTime / totalSessionCount
        : 0.0;
